...
// ClientConnectedHandler is a handler for new socket connections
func (engine *Engine) ClientConnectedHandler(response http.ResponseWriter, request *http.Request) {
